				...
				<ul class="nav ace-nav">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<span class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${yname}</span>
							<i class="icon-caret-down"></i>
						</a>
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">

							<li><a href="${pageContext.request.contextPath}/login.jsp" id="Exit_system"><i class="icon-off"></i>退出</a></li>
						</ul>
					</li>
				</ul>
			...
			<div class="sidebar" id="sidebar">
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						...
						<li>
							<a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text"> 员工管理 </span><b
									class="arrow icon-angle-down"></b></a>
									<!--左边导航  -->
							<ul class="submenu">
								<li class="home">
									<a href="javascript:void(0)" name="${pageContext.request.getContextPath()}/departmentQueryServlet"  title="部门管理"
										class="iframeurl"><i class="icon-double-angle-right"></i>部门管理</a></li>
								<li class="home">
									<a href="javascript:void(0)" name="${pageContext.request.getContextPath()}/EmployeeQueryServlet" title="员工管理"
										class="iframeurl"><i class="icon-double-angle-right"></i>员工管理</a></li>
